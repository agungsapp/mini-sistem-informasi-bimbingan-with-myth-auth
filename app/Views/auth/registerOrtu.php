    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
            <div class="col-lg-6">
                ...
                <h1 class="text-center mb-3">Register Orang Tua</h1>
                ...
                <form method="POST" id="regisForm" action="<?= url_to('registerOrtu') ?>">
                    <?= csrf_field() ?>
                    <!-- Nama Siswa input -->
                    <div class="form-floating mb-3">
                        <input class="form-control <?php if (session('errors.username')) : ?>is-invalid<?php endif ?>" id="namasiswa" name="username" type="text" value="<?= old('username') ?>" required />
                        <label for="namasiswa">Username</label>
                    </div>
