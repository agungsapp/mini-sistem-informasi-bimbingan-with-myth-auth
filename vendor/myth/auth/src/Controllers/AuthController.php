...
class AuthController extends Controller
{
    ...
    public function attemptLogin()
    {
        ...
        if (!$this->auth->attempt([$type => $login, 'password' => $password], $remember)) {
            // dd($this->auth->error(), $login, $password);
    ...
    public function registerSiswa()
    {
        ...
        return $this->_render($this->config->views['registerSiswa'], ['config' => $this->config]);
    }
    public function registerOrtu()
    {
        // check if already logged in.
        if ($this->auth->check()) {
            return redirect()->back();
        ...
        return $this->_render($this->config->views['registerOrtu'], ['config' => $this->config]);
    }

    /**
     * Attempt to register a new user.
     */
    public function attemptRegisterSiswa()
    {
        // Check if registration is allowed
        if (!$this->config->allowRegistration) {
            return redirect()->back()->withInput()->with('error', lang('Auth.registerDisabled'));
        ...
        // Dapatkan instance dari GroupModel
        ...
        if ($group) {
            // Dapatkan instance dari authorization service
