...
class Auth extends BaseConfig
{
    ...
    public $views = [
        ...
        'registerSiswa'        => '\App\Views\auth\registerSiswa',
        'registerOrtu'        => '\App\Views\auth\registerOrtu',
     ...
     * @var int
     */
    public $minimumPasswordLength = 1;
